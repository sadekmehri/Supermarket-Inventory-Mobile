...
enum HttpStatusUtils {

    NoConnection(-1, "No Connection", "Your network status is off. Please turn on wifi or your mobile cellular data."),
    ...
    HttpStatusUtils(int code, String name, String description) {
        this.code = code;
        this.name = name;
        this.description = description;
    }

    public static HttpStatusUtils getByCode(int httpStatus) {
        for (HttpStatusUtils status : HttpStatusUtils.values()) {
    ...
    public static HttpStatusUtils getByCode(String httpStatus) {
        int statusCode;
        try {
